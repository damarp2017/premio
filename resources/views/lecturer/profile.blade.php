        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <small class="text-muted">NIPY</small>
                    <h6>{{ Auth::user()->nipy }}</h6>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-body">
                                <form action="{{ route('lecturer.update-my-profile', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nipy" required type="text" class="form-control"
                                                           placeholder="Enter NIPY" value="{{ Auth::user()->nipy }}" maxlength="8">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
