    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 col-4 align-self-center">
            <div class="d-flex m-t-10 justify-content-end">
                <a href="{{ route('admin.create-user-admin') }}" class="btn btn-outline-info btn-sm"><i
                            class="ti-plus"></i>&ensp;Create New</a>
            </div>
        </div>
    </div>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            @foreach($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <img src="{{ asset('images/'.$admin->image) }}" alt="admin-user"
                                                 height="40">
                                        </center>
                                    </td>
                                    <td>{{ $admin->name }}</td>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{ route('admin.edit-user-admin', $admin->id) }}"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('admin.destroy-user-admin', $admin->id) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <p>
                                                                Are you sure to remove "
                                                                <b class="text-danger">{{ $admin->name }}</b>"
                                                                ?
                                                            </p>
