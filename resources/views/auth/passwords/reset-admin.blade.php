...
<head>
    ...
    <title>Premio | Admin Recover Password</title>
...
<section id="wrapper">
    <div class="login-register" style="background-image:url({{ asset('material-pro/assets/images/background/lock.jpg') }});">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('admin.password.request') }}" method="POST">
                    <h3 class="box-title m-b-20">Admin Recover Password</h3>
                    @csrf
